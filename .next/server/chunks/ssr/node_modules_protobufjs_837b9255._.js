 ...
 */ Namespace.prototype._lookupImpl = function lookup(path) {
    ...
    if (found) {
        if (path.length === 1) {
            exact = found;
        } else if (found instanceof Namespace && (found = found._lookupImpl(path.slice(1)))) exact = found;
    // Otherwise try each nested namespace
    } else {
        for(var i = 0; i < this.nestedArray.length; ++i)if (this._nestedArray[i] instanceof Namespace && (found = this._nestedArray[i]._lookupImpl(path))) exact = found;
    }
...
//# sourceMappingURL=node_modules_protobufjs_837b9255._.js.map